#!/usr/bin/python
#
# Title:       Important SUMA Security Announcement for auditlog-keeper SUSE-SU-2012:0958-1
...
META_CLASS = "Security"
META_CATEGORY = "SUMA"
META_COMPONENT = "auditlog-keeper"
PATTERN_ID = os.path.basename(__file__)
PRIMARY_LINK = "META_LINK_Security"
OVERALL = Core.TEMP
OVERALL_INFO = "NOT SET"
OTHER_LINKS = "META_LINK_Security=http://lists.opensuse.org/opensuse-security-announce/2012-08/msg00001.html"
Core.init(META_CLASS, META_CATEGORY, META_COMPONENT, PATTERN_ID, PRIMARY_LINK, OVERALL, OVERALL_INFO, OTHER_LINKS)

LTSS = False
NAME = 'auditlog-keeper'
MAIN = ''
SEVERITY = 'Important'
TAG = 'SUSE-SU-2012:0958-1'
PACKAGES = {}
